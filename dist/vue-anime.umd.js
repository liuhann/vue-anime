(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-anime"] = factory();
	else
		root["vue-anime"] = factory();
...
// CONCATENATED MODULE: ./src/anime-prop.js
...
// CONCATENATED MODULE: ./src/anime-mixin.js
...
/* harmony default export */ var anime_mixin = ({
  ...
  methods: {
    initAnime: function initAnime() {
      ...
      this.anime.update = function (anim) {
        _this.$emit('update', anim);
      };

      this.anime.begin = function (anim) {
        _this.$emit('begin', anim);
      };

      this.anime.complete = function (anim) {
        _this.$emit('complete', anim);
      };
    },
    ...
    getAnimeConfig: function getAnimeConfig(inherit) {
      var animeConfig = {};
    ...
    setFromProperties: function setFromProperties(animeConfig) {
      var _this2 = this;
      ...
      var _loop = function _loop(key) {
        if (validTransforms.includes(key)) {
          var transformValue = is.str(_this2.from[key]) ? _this2.from[key] : "".concat(_this2.from[key]).concat(_this2.getTransformUnit(key));
          transforms.push("".concat(key, "(").concat(transformValue, ")"));
        } else {
          if (is.arr(animeConfig.targets)) {
            animeConfig.targets.forEach(function (el) {
              el.style[key] = _this2.from[key];
            });
          } else {
            animeConfig.targets.style[key] = _this2.from[key];
          }
        }
      };
      ...
      if (transforms.length) {
        var transfromStr = transforms.join(' ');
    ...
    // copy from animejs
    getTransformUnit: function getTransformUnit(propName) {
...
// CONCATENATED MODULE: ./src/vue-anime.js
...
/* harmony default export */ var vue_anime = ({
  ...
  render: function render(h) {
    ...
    if (footer) {
      children = slots ? _toConsumableArray(slots).concat(_toConsumableArray(footer)) : _toConsumableArray(footer);
    }
...
// CONCATENATED MODULE: ./src/vue-anime-group.js
...
/* harmony default export */ var vue_anime_group = ({
  ...
  methods: {
    getTargets: function getTargets() {
      ...
      try {
        for (var _iterator = this.animes[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    addAnime: function addAnime(anime) {
      this.animes.push(anime);
    }
  }
});
// CONCATENATED MODULE: ./src/vue-anime-timeline.js
...
/* harmony default export */ var vue_anime_timeline = ({
  ...
  methods: {
    initAnimeTimeLine: function initAnimeTimeLine() {
      var _this = this;
      ...
      this.animeInstance = anime_min_default.a.timeline({
        ...
        loop: this.loop,
        delay: this.delay,
        // adding delay for the case of group time line
        autoplay: false
      });
      ...
      this.animeInstance.update = function (anim) {
        _this.$emit('update', anim);
      };

      this.animeInstance.begin = function (anim) {
        _this.$emit('begin', anim);
      };

      this.animeInstance.complete = function (anim) {
        _this.$emit('complete', anim);
      };
    ...
    getTargets: function getTargets() {
      ...
      try {
        for (var _iterator2 = this.animes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var _anime = _step2.value;
          targets.push(_anime.$el);
        }
      } catch (err) {
...
/* concated harmony reexport VueAnime */__webpack_require__.d(__webpack_exports__, "VueAnime", function() { return vue_anime; });
/* concated harmony reexport VueAnimeGroup */__webpack_require__.d(__webpack_exports__, "VueAnimeGroup", function() { return vue_anime_group; });
/* concated harmony reexport VueAnimeTimeLine */__webpack_require__.d(__webpack_exports__, "VueAnimeTimeLine", function() { return vue_anime_timeline; });
